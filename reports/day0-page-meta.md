...
```
Series card for Day 3 — Convenience stores and the advantage hiding in plain sight. Key figure: 14.2% of single-owner convenience stores lasted thirteen years, against 78.7% of the fuel-selling chains.
```
